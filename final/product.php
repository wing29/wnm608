...
<head>
	<meta charset="UTF-8">
	<title>Robot Pendulum Clock</title>
...
<body>
	<div class="container">
		...
		<section class="product-content padded">
			...
			<div class="row">
				<div class="image-slider column col-7 col-ms-6 col-xs-12">
				...
				<!-- product info -->
				<div class="product-info column col-4 col-ms-6 col-xs-12">
						<div class="text-info ">
							<h4>Robot Pendulum Clock</h4>
							<h5>$42.00</h5>
							<p>Handcrafted by Paul Ocepek, this friendly robot clock is made of laser cut plywood, and printed with non-toxic, water-based inks. The final sanding and assembly is all done by hand in Massachusetts. Mechanism made in the USA. Requires one AA battery (not included).</p>
							<p>Dimension: 11h x 9w x 1.25"d</p>
		...
		<!-- related products -->
		<section class="gallery padded nt">
			<div class="row">
				<!-- product1 -->
				<div class="product column col-3 col-ms-6 col-xs-12">
					<div class="image-wrapper">
						<img src="images/gallery/A1_Plants.jpg" alt="">

						<div class="caption-wrapper">
							<div class="caption padded nd">
